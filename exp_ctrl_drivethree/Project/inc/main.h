...
#define	 LED_MOT3_ON		GPIO_ResetBits(GPIOC,GPIO_Pin_14)
#define	 LED_MOT3_OFF		GPIO_SetBits(GPIOC,GPIO_Pin_14)
...
#define  IN1_2_STATE            ((GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_1))&0x1)//二区光电1
#define  IN2_1_STATE            ((GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_4))&0x1)//一区光电2
#define  IN2_2_STATE            ((GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5))&0x1)//二区光电2
#define  IN3_1_STATE            ((GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_10))&0x1)//顶升区域光电1
#define  IN3_2_STATE            ((GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11))&0x1)//顶升区域光电2
...
#define  MOT3_ALARM_IN          GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1)//无连接默认上拉,无故障输入低,故障输入高12V
...
#define  MOT3_DIR(BitVal)       GPIO_WriteBit(GPIOC,GPIO_Pin_15,BitVal)//默认输出高12V(CW),输出反向逻辑
...
#define  MOD_DIP_S8             ((~GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_4))&0x1)
...
#define  SW_DIP_S1             ((GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_13))&0x1)
#define  SW_DIP_S2             ((GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_5))&0x1)
#define  SW_DIP_S3             ((GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4))&0x1)
#define  SW_DIP_S4             ((GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_15))&0x1)

...
sInput_Info input_in3_1;
sInput_Info input_in3_2;
sInput_Info input_mot1_alarm;
sInput_Info input_mot2_alarm;
sInput_Info input_mot3_alarm;
...
void gpio_handleInputScan()
{
    ...
    u8 dip_mod_value_t = MOD_DIP_S1 | (MOD_DIP_S2 << 1) | (MOD_DIP_S3 << 2) | (MOD_DIP_S4 << 3) | (MOD_DIP_S5 << 4) | (MOD_DIP_S6 << 5) | (MOD_DIP_S7 << 6) | (MOD_DIP_S8 << 7);
    ...
    // handle INX1 single
    if (input_in3_1.input_state != IN3_1_STATE
        && input_in3_1.input_confirm_times == 0)
    {
        input_in3_1.input_middle_state = IN3_1_STATE;
    }
    if (input_in3_1.input_middle_state == IN3_1_STATE
        && input_in3_1.input_middle_state != input_in3_1.input_state)
    {
        ...
        if (input_in3_1.input_confirm_times > 10)
        {
            ...
            {
                input_in3_1.input_trig_mode = INPUT_TRIG_DOWN;
            }
        }
    }
    else
    ...
    // handle INX2 single
    if (input_in3_2.input_state != IN3_2_STATE
        && input_in3_2.input_confirm_times == 0)
    {
        input_in3_2.input_middle_state = IN3_2_STATE;
    }
    if (input_in3_2.input_middle_state == IN3_2_STATE
        && input_in3_2.input_middle_state != input_in3_2.input_state)
    {
        ...
        if (input_in3_2.input_confirm_times > 10)
        {
            ...
            {
                input_in3_2.input_trig_mode = INPUT_TRIG_DOWN;
            }
        }
    }
    else
        ...
        && input_mot3_alarm.input_middle_state != input_mot3_alarm.input_state)
    {
        ...
        if (input_mot3_alarm.input_confirm_times > 100)
        {
            input_mot3_alarm.input_state = input_mot3_alarm.input_middle_state;
            input_mot3_alarm.input_confirm_times = 0;
            if (input_mot3_alarm.input_state == 1)
            {
                input_mot3_alarm.input_trig_mode = INPUT_TRIG_UP;
            }
            else
            {
                input_mot3_alarm.input_trig_mode = INPUT_TRIG_DOWN;
            }
        }
    }
    else
...
void gpio_Led_Set_Mode(u8 led, u8 mode)
{
    ...
    else if (led == LED_MOT3)
    {
        switch (mode)
        {
        case LED_OFF:
            LED_MOT3_OFF;
            led_mot3_blk_mode = LED_OFF;
            break;
        case LED_ON:
            LED_MOT3_ON;
            led_mot3_blk_mode = LED_ON;
            break;
        case LED_B:
            led_mot3_blk_mode = LED_B;
            break;
        case LED_BL:
            led_mot3_blk_mode = LED_BL;
            break;
        default:
            break;
        }
...
void gpio_Led_Blink_Handle(void)
{
    ...
    if (led_blink_cnt < 500)
    {
        ...
        if ((led_mot3_blk_mode == LED_B) || (led_mot3_blk_mode == LED_BL))
        {
            LED_MOT3_ON;
        }
    }

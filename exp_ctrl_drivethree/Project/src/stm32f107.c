...
void CAN_Configuration(void)
{
    ...
    //CAN_InitStructure.CAN_BS2 = CAN_BS2_2tq;    //SamplePoint  (1+9) / (1+9+2) = 83.3%
...
void System_Setup(void)
{
    ...
    /* Enable USART2 clock */
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_BKP | RCC_APB1Periph_PWR | RCC_APB1Periph_CAN1 | RCC_APB1Periph_CAN2, ENABLE);
...
void GPIO_Configuration(void)
{
    ...
    //LED_MOT1,LED_MOT2, LED_MOT3,LED_STATUS 
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_14;
    ...
    //input(IN1_1,IN1_2,IN2_1,IN2_2,IN3-1,IN3-2)
    ...
    //input(MOT1_ALARM,MOT2_ALARM,MOT3_ALARM)
    ...
    //output(MOT1_DIR,MOT2_DIR,MOT3_DIR)
...
//    GPIO_PinRemapConfig(GPIO_Remap_SWJ_NoJTRST,ENABLE);
    ...
    //new sw6-1 6-2 6-4 6-8 
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13 ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOC, &GPIO_InitStructure);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5 | GPIO_Pin_4 | GPIO_Pin_15;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
...
void PWM_OUT_Init(void)
{
    ...
    TIM_SetCompare1(TIM5, 0);//7660(10V)
}
